...
try {
  ...
  const [
    ...
    campingsReinoUnido,
    campingsPolonia,
    campingsRepublicaCheca,
    campingsEslovaquia,
    campingsHungria,
    campingsRumania,
    campingsBulgaria,
    campingsSerbia,
    campingsMacedoniaNorte,
    campingsAlbania,
    campingsGrecia,
    campingsEstonia,
    campingsLetonia,
    ...
    cargarJSON(
      "campings-eslovenia-definitivo.json?v=1"
    ),
    ...
    cargarJSON(
      "campings-suecia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-noruega-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-finlandia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-islandia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-irlanda-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-reino-unido-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-polonia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-republica-checa-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-eslovaquia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-hungria-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-rumania-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-bulgaria-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-serbia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-macedonia-del-norte-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-albania-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-grecia-definitivo.json?v=1"
    ),

    cargarJSON(
      "campings-estonia-definitivo.json?v=1"
    ),
    ...
    cargarJSON(
      "campings-moldavia-definitivo.json?v=1"
    ),
    ...
    cargarJSON(
      "campings-kosovo-definitivo.json?v=1"
    )
...
const esloveniaNormalizada =
  campingsEslovenia.map(
    normalizarCamping
  );


const croaciaNormalizada =
  campingsCroacia.map(
    normalizarCamping
  );
...
const bosniaHerzegovinaNormalizada =
  campingsBosniaHerzegovina.map(
    normalizarCamping
  );
...
const sueciaNormalizada =
  campingsSuecia.map(
    normalizarCamping
  );


const noruegaNormalizada =
  campingsNoruega.map(
    normalizarCamping
  );


const finlandiaNormalizada =
  campingsFinlandia.map(
    normalizarCamping
  );


const islandiaNormalizada =
  campingsIslandia.map(
    normalizarCamping
  );


const irlandaNormalizada =
  campingsIrlanda.map(
    normalizarCamping
  );


const reinoUnidoNormalizado =
  campingsReinoUnido.map(
    normalizarCamping
  );


const poloniaNormalizada =
  campingsPolonia.map(
    normalizarCamping
  );


const republicaChecaNormalizada =
  campingsRepublicaCheca.map(
    normalizarCamping
  );


const eslovaquiaNormalizada =
  campingsEslovaquia.map(
    normalizarCamping
  );


const hungriaNormalizada =
  campingsHungria.map(
    normalizarCamping
  );


const rumaniaNormalizada =
  campingsRumania.map(
    normalizarCamping
  );


const bulgariaNormalizada =
  campingsBulgaria.map(
    normalizarCamping
  );


const serbiaNormalizada =
  campingsSerbia.map(
    normalizarCamping
  );


const macedoniaNorteNormalizada =
  campingsMacedoniaNorte.map(
    normalizarCamping
  );


const albaniaNormalizada =
  campingsAlbania.map(
    normalizarCamping
  );


const greciaNormalizada =
  campingsGrecia.map(
    normalizarCamping
  );


const estoniaNormalizada =
  campingsEstonia.map(
    normalizarCamping
  );


const letoniaNormalizada =
  campingsLetonia.map(
    normalizarCamping
  );
...
const moldaviaNormalizada =
  campingsMoldavia.map(
    normalizarCamping
  );


const ucraniaNormalizada =
  campingsUcrania.map(
    normalizarCamping
  );
...
campings = [
  ...
  ...sueciaNormalizada,
  ...noruegaNormalizada,
  ...finlandiaNormalizada,
  ...islandiaNormalizada,
  ...irlandaNormalizada,
  ...reinoUnidoNormalizado,
  ...poloniaNormalizada,
  ...republicaChecaNormalizada,
  ...eslovaquiaNormalizada,
  ...hungriaNormalizada,
  ...rumaniaNormalizada,
  ...bulgariaNormalizada,
  ...serbiaNormalizada,
  ...macedoniaNorteNormalizada,
  ...albaniaNormalizada,
  ...greciaNormalizada,
  ...estoniaNormalizada,
  ...letoniaNormalizada,
