...
export async function calculateRoute({ waypoints, vehicle, provider, includeCountryDetails = false }) {
  ...
  const route = await provider.route({ points, vehicle, includeCountryDetails });
