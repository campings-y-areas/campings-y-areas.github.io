...
try {
  ...
  const [
    ...
    cargarJSON(
      "areas-irlanda-definitivo.json?v=1"
    ),

    cargarJSON(
      "areas-reino-unido-definitivo.json?v=1"
    ),

    cargarJSON(
      "areas-grecia-definitivo.json?v=1"
    ),

    cargarJSON(
      "areas-estonia-definitivo.json?v=1"
    ),
    ...
    cargarJSON(
      "areas-ucrania-definitivo.json?v=1"
    ),

    cargarJSON(
      "areas-chipre-definitivo.json?v=1"
    ),

    cargarJSON(
      "areas-kosovo-definitivo.json?v=1"
    )
